...
let assetid="";
let emp="";
const empsearch=document.getElementById("employeeSearch") as HTMLInputElement;
...
save.addEventListener("click",()=>{
  const id=(document.getElementById("assetId") as HTMLInputElement).value.trim().toUpperCase();
...
document.addEventListener("click",(event)=>{
  ...
  (document.getElementById("assignedDate") as HTMLInputElement).value=asset.assignedDate||"";
  (document.getElementById("serviceDate") as HTMLInputElement).value=asset.serviceDate||"";
  (document.getElementById("returnDate") as HTMLInputElement).value=asset.returnDate||"";
  assignmodal.style.display="block";
  showemp("");
});

function showemp(search:string){
  emplist.innerHTML="";
  const employees=getemp();
  const text=search.toLowerCase().trim();
  const active=employees.filter((employee:any)=>{
...
assign.addEventListener("click",()=>{
  const adate=(document.getElementById("assignedDate") as HTMLInputElement).value;
  const sdate=(document.getElementById("serviceDate") as HTMLInputElement).value;
  const rdate=(document.getElementById("returnDate") as HTMLInputElement).value;
  const asset=assets.find((asset)=>asset.id===assetid);
